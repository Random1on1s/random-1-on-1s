...
class TestRandom1on1Bot:
    ...
    def test_empty_token(self):
        with pytest.raises(PreconditionError):
            Random1on1Bot(token="", config=Random1on1BotConfig(guild_id=TEST_GUILD_ID))
    ...
    def test_category_creation_no_existing_categories_same_name(self, mocker):
        bot = self.create_default_bot()
        existing_category_different_name = mocker.patch('discord.CategoryChannel') 
    ...
    def test_category_creation_multiple_existing_categories_same_name(self, mocker):
        bot = self.create_default_bot()
        ...
        mocker.patch('bot.guild.channels', [existing_category_same_name_1, existing_category_same_name_2])
    ...
    def test_role_creation_multiple_existing_categories_same_name(self, mocker):
        bot = self.create_default_bot()
        ...
        mocker.patch('bot.guild.roles', [existing_role_same_name_1, existing_role_same_name_2])
        with pytest.raises(RuntimeError):
